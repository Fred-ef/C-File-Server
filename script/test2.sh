...
#fourth command
./client -f ./tmp/fileserver.sk -d ./saved/ -W ./files/file1.txt,./files/file2.txt,./files/file3.txt -p -R n=0 -l ./files/file1.txt,./files/file2.txt -W ./files/file1.txt,./files/file3.txt -W ./files/file1.txt,./files/file3.txt -D ./expelled/
